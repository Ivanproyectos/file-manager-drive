...
namespace FileManagement.Persistence.Migrations
{
    ...
    [Migration("20250323175053_seedStorageProvider")]
    partial class seedStorageProvider
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.People", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "123 Main St",
                            CreatedAt = new DateTime(2025, 3, 23, 12, 50, 53, 690, DateTimeKind.Local).AddTicks(3191),
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 23, 12, 50, 53, 690, DateTimeKind.Local).AddTicks(5911),
                            CreatedBy = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 3, 23, 12, 50, 53, 690, DateTimeKind.Local).AddTicks(5920),
                            CreatedBy = 1,
                            Description = "Usuario",
                            RoleName = "User"
                        });
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.StorageProvider", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 23, 17, 50, 53, 691, DateTimeKind.Utc).AddTicks(2953),
                            CreatedBy = 1,
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 23, 12, 50, 53, 692, DateTimeKind.Local).AddTicks(5828),
                            PasswordHash = "change password for password hash",
                            PeopleId = 1,
                            Status = true,
                            UpdatedAt = new DateTime(2025, 3, 23, 12, 50, 53, 692, DateTimeKind.Local).AddTicks(5831),
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 23, 12, 50, 53, 693, DateTimeKind.Local).AddTicks(3630),
                            CreatedBy = 1,
                            RoleId = 1,
                            UserId = 1
                        });
