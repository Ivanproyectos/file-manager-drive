...
namespace FileManagement.Persistence.Migrations
{
    ...
    [Migration("20250419150440_AddFieldFileTemp")]
    partial class AddFieldFileTemp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.FileTemp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FilesTemp", (string)null);
                });

            modelBuilder.Entity("FileManagement.Core.Entities.FileUploadConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FileUploadConfigurations", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 583, DateTimeKind.Local).AddTicks(4005),
                            CreatedBy = 1,
                            MaxFileSizeBytes = 2199023255552L,
                            UpdatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 583, DateTimeKind.Local).AddTicks(4019),
                            UpdatedBy = 1
                        });
                });
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.FolderProcessState", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 584, DateTimeKind.Local).AddTicks(6720),
                            CreatedBy = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 584, DateTimeKind.Local).AddTicks(6736),
                            CreatedBy = 1,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 584, DateTimeKind.Local).AddTicks(6739),
                            CreatedBy = 1,
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.People", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "123 Main St",
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 589, DateTimeKind.Local).AddTicks(8887),
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 590, DateTimeKind.Local).AddTicks(1777),
                            CreatedBy = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 590, DateTimeKind.Local).AddTicks(1783),
                            CreatedBy = 1,
                            Description = "Usuario",
                            RoleName = "User"
                        });
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.StorageProvider", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 19, 15, 4, 40, 590, DateTimeKind.Utc).AddTicks(9886),
                            CreatedBy = 1,
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 591, DateTimeKind.Local).AddTicks(3878),
                            HasChangedPassword = false,
                            IsExpired = false,
                            PasswordHash = "change password for password hash",
                            PeopleId = 1,
                            Status = true,
                            UpdatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 591, DateTimeKind.Local).AddTicks(3882)
                        });
                });
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 19, 10, 4, 40, 592, DateTimeKind.Local).AddTicks(2082),
                            CreatedBy = 1,
                            RoleId = 1,
                            UserId = 1
                        });
