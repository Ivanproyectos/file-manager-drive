...
namespace FileManagement.Persistence.Migrations
{
    ...
    [Migration("20250316170905_InitialMigration")]
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.People", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "123 Main St",
                            CreatedAt = new DateTime(2025, 3, 16, 12, 9, 5, 717, DateTimeKind.Local).AddTicks(3221),
            ...
            modelBuilder.Entity("FileManagement.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 16, 12, 9, 5, 720, DateTimeKind.Local).AddTicks(1688),
                            PasswordHash = "admin",
                            PeopleId = 1,
                            Status = true,
                            UpdatedAt = new DateTime(2025, 3, 16, 12, 9, 5, 720, DateTimeKind.Local).AddTicks(1693),
                            Username = "admin"
                        });
                });
