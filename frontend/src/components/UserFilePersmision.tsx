...
export const UserFilePersmision = ({
  ...
  const handleSelectedUser = (userSummary: IUserSummary) => {
    if(state?.users?.find((user: IUserFilePermission) => user.id === userSummary.id)) return
  ...
  const handleUpdateUser = (user: IUserFilePermission) => {
  ...
  return (
    ...
    {state?.users?.length === 0 && ( 
      ...
      <div className="d-flex flex-column align-items-center justify-content-center" aria-live="polite" role="alert">
        <img height={200} width={200} src="../assets/svg/illustrations/oc-empty-cart.svg" className="mb-2" alt="list empty" data-hs-theme-appearance="default" />
        <img height={200} width={200} src="../assets/svg/illustrations-light/oc-empty-cart.svg"  className="mb-2" alt="list empty" data-hs-theme-appearance="dark" />
