...
export const LoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login</title>
        <meta name="description" content="gestion de archivos | grupo qhuya" />
        <meta name="keywords" content="archivos, carpetas, gestion" />
        <meta property="og:title" content="login page" />
        <meta property="og:description" content="gestion de archivos | grupo qhuya" />
      </Helmet>
